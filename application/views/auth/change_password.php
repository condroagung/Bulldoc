          ...
          <div class="col-lg">
            <div class="p-5">
              <div class="text-center">
                <h1 class="h4 text-gray-900 mb-4">Change Password Now!</h1>
              </div>
              <?= form_open_multipart('auth/change_password') ?>
                ...
                <button type="submit" class="btn btn-outline-success btn-user btn-block" style="margin-top:30px;">
                  Change Now
                </button>
              <?= form_close() ?>
              <hr>
              <div class="text-center" style="margin-left:380px; margin-top:10px;" >
                    <a class="small"  href="<?php echo base_url('auth/login');?>">Already Change your password! Login Now</a>
              </div>
            </div>
          </div>
        </div>
